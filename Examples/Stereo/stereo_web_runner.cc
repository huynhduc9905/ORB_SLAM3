...
int main(int argc, char **argv)
{
    ...
    if(!ORB_SLAM3::CrashMonitor::Install("/data/orbslam3_artifacts/crash_reports", "stereo_web_runner"))
    ...
    ORB_SLAM3::System SLAM(strVocFile, strSettingsFile, ORB_SLAM3::System::STEREO, true);
